...
// write must not land on the restored list, and the kernel must be brought
// back to it once the write has answered. Unconditional — a discrete toggle's
// write can be in flight with no bracket open at all.
