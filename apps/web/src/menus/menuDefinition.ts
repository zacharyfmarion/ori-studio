      ...
      items: [
        ...
        { type: 'separator' },
        {
          ...
          items: [
            ...
            {
              type: 'action',
              id: 'file.exportFoldedFold',
              label: t('menu:file.exportFoldedFold', 'Export Folded FOLD...'),
            },
            { type: 'action', id: 'file.exportObj', label: t('menu:file.exportObj', 'Export OBJ...') },
            { type: 'action', id: 'file.exportStl', label: t('menu:file.exportStl', 'Export STL...') },
          ],
        },
        { type: 'separator' },
