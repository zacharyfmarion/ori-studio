...
export const CONSTRUCT_LESSONS: readonly Lesson[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        check: { mode: 'exact' },
        hint: 'Press S for valley, then Y for the perpendicular tool. Click the middle of the bottom edge, then the horizontal crease — the new crease is drawn between them at a right angle. Drawing it by hand also counts if it lands in the same place.',
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        check: { mode: 'exact' },
        hint: 'Press S for valley, then B for the bisector tool. Select the two creases meeting at the centre, then the crease or edge you want the bisector to run to.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        check: { mode: 'exact' },
        hint: 'Press Q and box-select the two creases, then Cmd+M for the reflect tool, then click the two ends of the vertical line through the middle of the paper.',
      },
    ],
  },
];
