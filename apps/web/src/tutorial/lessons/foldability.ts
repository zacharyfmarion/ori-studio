    ...
    steps: [
      ...
      },
      {
        ...
        body: [
          ...
          'So a clean overlay is not a promise. The checker can prove a vertex is broken, never that a pattern folds \u2014 folding and simulating are how you find out the rest.',
        ],
