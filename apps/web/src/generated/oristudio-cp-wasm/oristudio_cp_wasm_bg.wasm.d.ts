...
export const export_fold_file: (a: number, b: number, c: number) => [number, number, number, number];
export const export_orh: (a: number) => [number, number, number, number];
export const export_ori: (a: number) => [number, number, number, number];
export const export_share_link: (a: number) => [number, number, number, number];
export const folded_figure_3d_duplicate: (a: number) => [number, number, number];
export const folded_figure_3d_fold_another: (a: number) => [number, number, number];
...
export const folded_figure_fold_3d: (a: number, b: any, c: number, d: any) => [number, number, number];
