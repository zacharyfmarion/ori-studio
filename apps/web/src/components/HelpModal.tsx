...
const HELP_TOPICS: HelpTopic[] = [
  {
    ...
    imageAlt: 'File menu showing New, Open, Open Recent, Examples, Save, and export commands',
    caption: 'The File menu keeps project actions, exports, examples, and recent work in one place.',
    steps: [
      'New returns to the start screen; Open accepts .osf, .tmd, .tmd4, .tmd5, .fold, .cp, .ori, and .orh files.',
      'File → Open Recent reopens recent projects, and File → Examples loads checked-in starter designs.',
  ...
  },
  {
    ...
    summary: 'The Simulator pane uses the flat-fold artifacts produced from built or imported crease patterns.',
  ...
  },
  {
    ...
    steps: [
      'Use the View menu to activate Design, Crease Pattern, Simulator, Conditions, or Diagnostics panes.',
