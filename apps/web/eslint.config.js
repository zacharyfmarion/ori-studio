...
const OVERSIZED_PANELS = {
  // 2860 -> 2926: inline simulation windows. The behaviour is in
  ...
  // more case in the viewport-shortcut switch, and the window's arm of the two
  // dispatches every canvas-object kind passes through (selection and delete).
  'CreasePatternPanel.tsx': 2926,
