...
and an elegant web version of it was developed by [Amber Kraft](https://github.com/amkraft/ReferenceFinder) (f.k.a. Robby Kraft) using a Node.js backend querying a pre-generated database.
