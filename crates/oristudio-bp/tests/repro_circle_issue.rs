...
use oristudio_bp::layout::{create_layout_junctions, LayoutJunction};
...
fn print_repro_junction_geometry() {
    ...
    let tree = BpTree::new(
        &[
            Edge { n1: 0, n2: 1, length: 1.0 },
            Edge { n1: 0, n2: 5, length: 1.0 },
            Edge { n1: 1, n2: 7, length: 1.0 },
        ],
        &[
            Flap { id: 5, x: 9.0, y: 8.0, width: 0.0, height: 0.0 },
            Flap { id: 7, x: 11.0, y: 6.0, width: 0.0, height: 0.0 },
        ],
    )
    .unwrap();
